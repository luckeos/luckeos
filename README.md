...
* 彩种取法
*     EOS时时彩类彩种：取开奖 HASH 最后 5 位数字作为开奖结果
*     EOS赛车类彩种  ：取开奖 HASH  从后往前取不重复的1-10，其中10使用十六进制a表示，如果当期开奖hash无法取满1-10十个
      不同的数字，则根据1-10顺序补足10个数字
*     EOS快三类彩种：取开奖 HASH 最后 3 位数字作为开奖结果，取值范围1-6
*     EOS飞艇类彩种  ：取开奖 HASH  从前往后取不重复的1-10，其中10使用十六进制a表示，如果当期开奖hash无法取满1-10十个
      不同的数字，则根据1-10顺序补足10个数字
*     EOS二八类彩种 取开奖 HASH 最后 3 位数字作为开奖结果，取值范围0-9
